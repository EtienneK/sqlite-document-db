...
exports.toJson1Extract = function (col, pathArr) {
  return `json_extract(${exports.quote2(col)}, ${exports.toJson1PathString(pathArr)})`
}

exports.toJson1PathString = function (pathArr) {
  return exports.quote(`$.${pathArr.join('.').replace(/\.(\d+)/g, '[$1]')}`)
}
...
exports.quote = function (data) {
  if (typeof data === 'string') return "'" + exports.stringEscape(data) + "'"
  if (typeof data === 'number') return data
  return `json(${exports.quote(JSON.stringify(data))})`
}

exports.quote2 = function (data) {
  if (typeof data === 'string') return '"' + exports.stringEscape2(data) + '"'
  if (typeof data === 'number') return data
  return `json(${exports.quote(JSON.stringify(data))})`
}
...
exports.stringEscape2 = function (str) {
  return str.replace(/"/g, '""')
}
...
exports.pathToText = function (path, isString) {
  ...
  for (var i = 1; i < path.length; i++) {
    ...
    else text += '\'' + exports.stringEscape(path[i]) + '\''
  }
  return text
}
...
exports.getPostgresTypeName = function (type) {
  if (!['string', 'number'].includes(typeof type)) {
    throw new Error({ errmsg: 'argument to $type is not a number or a string', code: 14 })
  }
